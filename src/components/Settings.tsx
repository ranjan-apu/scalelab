          ...
          {(onExport || onImport || onExportImage || onExportMermaid || (prefs.hldRfc && onExportHldMarkdown)) && (
            <section className="st-group">
              ...
              <div className="st-actions">
                ...
                {onExportMermaid && (
                  <button type="button" className="st-action" onClick={onExportMermaid}>
                    <Glyph d="M8 9l3 3-3 3m5 0h3M5 20h14a2 2 0 0 0 2-2V6a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2z" />
                    <span className="st-action-text">
                ...
                {prefs.hldRfc && onExportHldMarkdown && (
                  <button type="button" className="st-action" onClick={onExportHldMarkdown}>
                    ...
                    <span className="st-action-text">
                      <span className="st-row-label">Export Architecture Design RFC (.md)</span>
                      <span className="st-hint">
