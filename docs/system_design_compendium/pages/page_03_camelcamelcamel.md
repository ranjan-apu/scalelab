# Page 03: Price Tracking Service

> **Page Index**: Page 03 of 32  
> **System Domain**: Distributed Web Scraping & Time-Series Alerting  
> **Industry Analogs**: CamelCamelCamel, Keepa, Honey  
> **Interview Difficulty**: Medium  
> **Core Architectural Patterns**: Managing Long Running Tasks, Time Series, Multi-step Processes, Rate Limiter  
...
### Problem Summary
Designing **Price Tracking Service** requires architecting a production-grade distributed solution in the **Distributed Web Scraping & Time-Series Alerting** space. The system must support massive scale while balancing latency budgets, throughput requirements, data consistency, and system durability.
